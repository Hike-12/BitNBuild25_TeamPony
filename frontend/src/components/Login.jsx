  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isLogin) {
        ...
        // Use the register function from AuthContext with proper data structure
      ...
      if (result.success) {
        ...
        // Token is handled by AuthContext, no need to handle it here
      } else {
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundBlendMode: isDarkMode
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='${theme.primary.replace(
            "#",
            "%23"
      ...
      <div className="max-w-lg w-full space-y-8 relative z-10">
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center gap-4 mt-6 mb-8">
            ...
            ></div>
            <div
              className="w-2 h-2 rounded-full animate-pulse delay-700"
              style={{ backgroundColor: theme.primary }}
            ></div>
          </div>
        </div>
              ...
              <React.Fragment>
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    >
                      <Mail size={14} style={{ color: theme.secondary }} />
                    </div>
                    <input
                      id="email"
                      name="email"
            ...
            <div className="group">
              ...
              <div className="relative">
                <div
                  ...
                  style={{ backgroundColor: `${theme.primary}15` }}
                >
                  <Lock size={14} style={{ color: theme.primary }} />
                </div>
                <input
                  id="password"
                  name="password"
