    ...
    <div>
      ...
      {menus.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {menus.map((menu) => (
            <div key={menu.id || menu._id} className="rounded-sm shadow-md p-6 hover:scale-[1.02] transition-all"
              style={{ background: theme.panels, border: `1px solid ${theme.border}`,
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="px-3 py-1 rounded-full text-xs font-semibold flex items-center"
                  style={{
                    background: menu.is_active ? `${theme.success}15` : `${theme.error}15`,
              ...
              {/* Dabba Progress */}
              <div className="mb-4 p-3 rounded" style={{ background: theme.background }}>
