...
import { BsBoxSeam, BsCreditCard, BsPiggyBank } from "react-icons/bs";
...
const Dashboard = () => {
  ...
  const [dashboardData, setDashboardData] = useState({
    quickStats: [
      ...
      {
        title: "Reviews Given",
        value: "0", // Changed from dashboardData?.totalReviews
        change: "0 this month", // Changed from template string
        icon: FiStar,
        color: theme.warning,
        bg: `${theme.warning}15`,
      },
    ...
    totalReviews: 0, // Add these fields at the root level
    reviewsThisMonth: 0,
    recentOrders: [
      {
        id: "#ORD2024001",
  ...
  useEffect(() => {
    // Fetch reviews data and update the stats
    fetchReviewsStats();
  }, []);
  ...
  const fetchReviewsStats = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Update dashboard data with review stats
        setDashboardData((prev) => ({
          ...prev,
          totalReviews: feedbacks.length,
          reviewsThisMonth: thisMonthReviews,
          quickStats: prev.quickStats.map((stat) =>
            stat.title === "Reviews Given"
              ? {
                  ...stat,
                  value: feedbacks.length.toString(),
                  change: `${thisMonthReviews} this month`,
                }
              : stat
          ),
        }));
  ...
  const sidebarItems = [
    ...
    { id: "reviews", label: "My Reviews", icon: FiStar }, // NEW - Add this line
  ...
  const renderActiveComponent = () => {
    switch (activeTab) {
        ...
        return (
          <div className="space-y-6">
            ...
            <div>
              ...
              >
                Welcome back,{" "}
                {profile?.first_name || user?.username || "Friend"}! 🍽️
              </h2>
              <p className="text-lg" style={{ color: theme.textSecondary }}>
                Here's what's happening with your tiffin orders and
                subscriptions today.
              </p>
              <div
                      ...
                      >
                        <div
                          ...
                          style={{
                            ...
                            width: `${
                              ((sub.totalDays - sub.daysLeft) / sub.totalDays) *
                              100
                            }%`,
                          }}
                        />
      ...
      case "reviews": // NEW - Add this case
        return <MyReviews />;
      ...
      case "subscriptions":
        return <MySubscriptions></MySubscriptions>
        ...
        return (
          ...
          >
            ...
            <p style={{ color: theme.textSecondary }}>
              Your payment history and methods will appear here.
            </p>
          </div>
        );
      ...
      case "favorites":
        return (
          ...
          >
            ...
            <p style={{ color: theme.textSecondary }}>
              Your favorite vendors and dishes will appear here.
            </p>
          </div>
        );
